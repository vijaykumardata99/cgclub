...
<head>
    ...
    <title>Chhattisgarh Club Raipur | Add Coach</title>
    <!--favicon-->
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-lg-12 order-2">
                                <div class="add-member-form">
                                    ...
                                    <form action="/admin/store-coach" method="POST" class="member-form mt-30" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row form-row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="entryarea">
                                                    <input type="text" required name="coach_name">
                                                    <div class="labelline">Coach Name</div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="entryarea">
                                                    <input type="text" required name="coach_num">
                                        ...
                                        <div class="row form-row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="entryarea">
                                                    <input type="text" required name="sports_name">
                                                    <div class="labelline">Sports Name</div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="entryarea">
                                                    <input type="text" required name="designation">
                                                    <div class="labelline">Designation</div>
                                                </div>
                                            </div>
                                        </div>  <br>  
                                            <div class="col-lg-12">
